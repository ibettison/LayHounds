...
export const api = {
  ...
  exportPaperLiveReport: (id) => axios.get(`${API}/sessions/${id}/paper-live-report.csv`, { responseType: "blob" }).then((r) => r.data),
  exportLiveAudit: (id) => axios.get(`${API}/sessions/${id}/live-audit.csv`, { responseType: "blob" }).then((r) => r.data),
